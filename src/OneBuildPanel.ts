...
export class OneBuildPanel {
  /**
   * Track the currently panel. Only allow a single panel to exist at a time.
   */
  public static currentPanel: OneBuildPanel|undefined;
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (OneBuildPanel.currentPanel) {
      OneBuildPanel.currentPanel._panel.reveal(column);
      OneBuildPanel.currentPanel._update();
      return;
    }

    // Otherwise, create a new panel.
    const panel = vscode.window.createWebviewPanel(
        OneBuildPanel.viewType, 'one-build', column || vscode.ViewColumn.One, {
    ...
    OneBuildPanel.currentPanel = new OneBuildPanel(panel, extensionUri);
  }

  public static kill() {
    OneBuildPanel.currentPanel ?.dispose();
    OneBuildPanel.currentPanel = undefined;
  }
