...
static createOperatorCode(builder:flatbuffers.Builder, builtinCode:BuiltinOperator, customCodeOffset:flatbuffers.Offset, version:number):flatbuffers.Offset {
